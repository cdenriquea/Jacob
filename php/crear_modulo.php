...
if ($numRows == 0) {
    if ($_POST['Tipo'] == 'edit') {
        ...
        $sqlInsert = "INSERT INTO " . $_POST['Categoria'] . " (Puesto,CodiMate,Materia,Seccion,NombModulo,NombLeccion,NombSeccion,Contenido,Creador,idCreador) VALUES ('" . $_POST['Puesto'] . "','" . $_POST['Codigo'] . "','" . $_POST['Nombre'] . "','Teoría','" . $_POST['Modulo'] . "','NULL','NULL','NULL','" . $_POST['tipoCreador'] . "','" . $_POST['idCreador'] . "');";
    }
