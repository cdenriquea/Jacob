<?php
	...
	$sql = "SELECT c.CodBanc,c.Materia,c.Tema,c.Subtema,c.Enunciado,c.Explicacion,c.Opciones,c.Respuesta,c.Tiempo FROM banco_preguntas  AS c WHERE c.Materia ='".$_POST['Materia']."';";
