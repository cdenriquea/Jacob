      ...
      <div class="collapse navbar-collapse" id="barra">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item ml-2">
            <a class="nav-link border-right" ui-sref="home">Inicio</a>
          </li>
          <li class="nav-item ml-2">
            <a class="nav-link border-right" ui-sref="perfil">Perfil</a>
          </li>
          <li class="nav-item ml-2">
            <a class="nav-link border-right" ui-sref="repositorio">Repositorio</a>
          </li>
          <li class="nav-item ml-2">
            <a class="nav-link border-right" ui-sref="cursos">+ Cursos</a>
          </li>
          <li class="nav-item ml-2">
            <a class="nav-link border-right" ui-sref="foro()">Foro</a>
          </li>
        </ul>
